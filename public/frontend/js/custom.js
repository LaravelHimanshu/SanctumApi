/* --------------------------------------------------
 * © Copyright 2021 - EasyInsuranceMatch
 * --------------------------------------------------*/
(function($) {
  "use strict";
  ...
  function custom_elements() {
    ...
    // --------------------------------------------------
    jQuery(".de_tab")
      .find(".de_tab_content > div")
      .hide();
    jQuery(".de_tab")
      .find(".de_tab_content > div:first")
      .show();
    jQuery("li")
      .find(".v-border")
      .fadeTo(150, 0);
  ...
  function grid_gallery() {
    jQuery(".grid-item").each(function() {
      ...
      jQuery(this)
        .parent()
        .css("padding-left", this_gridspace);
      var w =
      ...
      $(this)
        .parent()
        .css("padding-top", this_gridspace);
  ...
  jQuery(document).ready(function() {
    ...
    jQuery(".blog-list")
      .on("mouseenter", function() {
        var v_height = jQuery(this)
          .find(".blog-slide")
          .css("height");
        var v_width = jQuery(this)
          .find(".blog-slide")
          .css("width");
